...
class RegistrationServiceTest {
    ...
    void register_whenScheduleIsScheduled_thenSuccess() {
        // given
        Long scheduleId = 1L;
        ...
        given(registrationRepository.existsByScheduleIdAndStudentIdAndStatus(scheduleId, studentId, RegistrationStatus.REGISTERED))
            .willReturn(false);
        given(registrationRepository.countByScheduleIdAndStatusRegisteredWithLock(scheduleId)).willReturn(0L);
    ...
    void register_whenScheduleIsNotScheduled_thenThrowException() {
        // given
        Long scheduleId = 1L;
        String studentId = UUID.randomUUID().toString();
    ...
    void register_whenDuplicateRegistration_thenThrowException() {
        // given
        Long scheduleId = 1L;
        String studentId = UUID.randomUUID().toString();
    ...
    void register_whenScheduleIsFull_thenThrowException() {
        // given
        Long scheduleId = 1L;
        String studentId = UUID.randomUUID().toString();
        ...
        given(registrationRepository.existsByScheduleIdAndStudentIdAndStatus(scheduleId, studentId, RegistrationStatus.REGISTERED))
            .willReturn(false);
        given(registrationRepository.countByScheduleIdAndStatusRegisteredWithLock(scheduleId)).willReturn(1L); // 이미 1명 등록됨
    ...
    void register_whenScheduleNotFound_thenThrowException() {
        // given
