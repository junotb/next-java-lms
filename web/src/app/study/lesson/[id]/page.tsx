...
import MeetLinkArea from "@/components/lesson/MeetLinkArea";
import LessonController from "@/components/lesson/LessonController";
...
export default function StudyLessonPage() {
  ...
  const { data, isLoading, isError } = useLessonAccess(id, {
    ...
    <div className="flex-1 flex flex-col min-h-0">
      <div className="flex-1 flex min-h-0 flex-col gap-2 p-2">
        <Accordion
          ...
          collapsible
          defaultValue="course"
          className="shrink-0 rounded-lg border border-zinc-800 bg-zinc-900/50"
        >
